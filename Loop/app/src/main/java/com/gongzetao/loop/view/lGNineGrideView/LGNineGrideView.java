package com.gongzetao.loop.view.lGNineGrideView;
...
//    private ImageCreator imageCreator;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            //加载图片
            Glide.with(context).load(url).asBitmap()/*.override(300, 200)*/.placeholder(R.color.lineColor).thumbnail(0.1f).into(view);
