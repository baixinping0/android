...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	protected void onFinishInflate() {
		...
		emojis = SpanableStringUtils.getInstace().emojiLists;
		onCreate();
	}
	...
	private void Init_View() {
		...
		et_sendmessage = (EditText) findViewById(R.id.et_message_frame);
		layout_point = (LinearLayout) findViewById(R.id.iv_image);
		et_sendmessage.setOnClickListener(this);
		//设置显示表情点击事件
		findViewById(R.id.iv_icon_emoticon).setOnClickListener(this);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (!TextUtils.isEmpty(emoji.getCharacter())) {
			...
			SpannableString spannableString = SpanableStringUtils.getInstace()
