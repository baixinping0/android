package com.gongzetao.loop.view.photoBrowser.widget;
...
import com.gongzetao.loop.view.photoBrowser.utils.PixelUtil;
...
public class CircularProgressBar extends CustomView {
	...
	public CircularProgressBar(Context context, AttributeSet attrs) {
        ...
        determinateProgressDrawable=new DeterminateProgressDrawable(getResources().getColor(R.color.lineColor), PixelUtil.dpToPx(ringWidth+1, getResources()),1);
...
//
    ...
    private void drawLastAnimation(Canvas canvas) {
        ...
        temp.drawCircle(getWidth() / 2, getHeight() / 2, (getWidth() / 2) - PixelUtil.dpToPx(ringWidth, getResources()), transparentPaint);
...
//				radius2 = (radius2 >= getWidth() / 2) ? (float) getWidth() / 2 : radius2 + 1;
				...
				radius2 = (radius2 >= getWidth() / 2 - PixelUtil.dpToPx(ringWidth, getResources())) ?
						(float) getWidth() / 2 - PixelUtil.dpToPx(ringWidth, getResources()) : radius2 + 1;
			}
            temp.drawCircle(getWidth() / 2, getHeight() / 2, radius2, transparentPaint);
			canvas.drawBitmap(bitmap, 0, 0, new Paint());
            bitmap.recycle();
			if (radius2 >= getWidth() / 2 - PixelUtil.dpToPx(ringWidth, getResources())) {
    ...
    private class DeterminateProgressDrawable extends Drawable {
        ...
        public DeterminateProgressDrawable(int color, int borderWidth, int angle) {
            ...
            mbgPaint.setStrokeWidth(PixelUtil.dpToPx(ringWidth, getResources()));
